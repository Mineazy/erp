...
export default function WorkshopReportsPage() {
  ...
  const downloadReport = (reportName: string, format: 'csv' | 'pdf') => {
    ...
    if (format === 'csv') {
      const headers = ['Workshop Report', reportName, 'Period', `${dateFrom} to ${dateTo}`];
      const rows = [
        [],
        ['Equipment Name', 'Serial Number', 'Last Service Date', 'Service Cost ($)', 'Technician Name', 'Uptime Status'],
        ['Excavator CAT 320', 'SN-CAT-9988', '2026-01-05', '1,250.00', 'Arthur Dent', '98.5% (Operational)'],
        ['Haul Truck Komatsu', 'SN-KOM-2211', '2026-01-10', '3,400.00', 'Ford Prefect', '95.2% (Operational)'],
        ['Drill Rig Sandvik', 'SN-SAN-7744', '2026-01-15', '5,100.00', 'Tricia McMillan', '88.0% (In Service)'],
      ];
    ...
    toast(`Workshop report "${reportName}" downloaded in ${format.toUpperCase()} format!`, 'success');
  };
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card className="bg-gradient-to-br from-blue-500 to-indigo-600 text-white shadow-md">
          <CardContent className="p-5 space-y-2">
            ...
            <h3 className="text-2xl font-bold font-mono">94.2%</h3>
        ...
        <Card className="bg-gradient-to-br from-emerald-500 to-teal-600 text-white shadow-md">
          <CardContent className="p-5 space-y-2">
            ...
            <h3 className="text-2xl font-bold font-mono">3.4 hrs</h3>
        ...
        <Card className="bg-gradient-to-br from-violet-500 to-purple-600 text-white shadow-md">
          <CardContent className="p-5 space-y-2">
            ...
            <h3 className="text-2xl font-bold font-mono">$9,750.00</h3>
        ...
        <Card className="bg-gradient-to-br from-amber-500 to-orange-600 text-white shadow-md">
          <CardContent className="p-5 space-y-2">
            ...
            <h3 className="text-2xl font-bold font-mono text-amber-100">8 Orders</h3>
            <span className="text-[10px] bg-white/25 px-2 py-0.5 rounded font-medium">5 preventive, 3 corrective</span>
          </CardContent>
        </Card>
      </div>
